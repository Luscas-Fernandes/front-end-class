      ...
      <main className="main">  
        <div className="who-are-we">
            ...
            <div className="our-team">
                <img src="./../imgs/pessoal-trabalhando.png" alt=""/>
                <img src="./../imgs/instalacao.jpg" alt=""/>
            </div>
            </div>
        </div>
        ...
        <div className="today-art">
            <p style={{ textAlign: "center" }}>Today's Trending Arts</p>
        </div>
        ...
        <table className="founders">
            ...
            <td>
                ...
                <p>CKO · Full Stack Web Developer</p>
                <a href="./../cvs/Lucas Fernandes.md" download>Lucas' curriculum vitae</a>
                <div className="circle-image">
                    <img src="https://media.licdn.com/dms/image/v2/C4E03AQE6BqqwUSrW1g/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1639008237663?e=1752105600&v=beta&t=q7Zpq7AbECEW8D7d7X1IyLkEqRkKfWfy8yJGIKbALF8" alt="Imagem de perfil"/>
                </div>
                </div>
            </td>
            <td>
                <div className="founder-container">
                <h2>Marília Pereira</h2>
                <p>CTO · Security Blue Team</p>
                <a href="./../cvs/Marilia Pereira.md" download>Marilia's curriculum vitae</a>
                <div className="circle-image">
                    <img src="https://media.licdn.com/dms/image/v2/C4E03AQH_v-ntDU_PFw/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1647698585672?e=1752105600&v=beta&t=jTyghxdmDjp0NCJbO9jt34v3-gbM1TjNHeZs9nhpCoU" alt="Imagem de perfil"/>
                </div>
                </div>
            </td>
            </tr>
            ...
            <td colspan="2">
                <div className="founder-container">
                <h2>Giovanna Numeriano</h2>
                <p>CEO · Security Red team</p>
                <a href="./../cvs/Giovanna Numeriano.md" download>Giovanna's curriculum vitae</a>
                <div className="circle-image">
                  <img src="https://media.licdn.com/dms/image/v2/C4D03AQG_5iekZDVrug/profile-displayphoto-shrink_100_100/profile-displayphoto-shrink_100_100/0/1616006771661?e=1752105600&v=beta&t=rCkjXE1mqPR0om__7lxSRnIvfEdgD7AUOZm3tjhEiTo" alt="Imagem de perfil"/>
                </div>
                </div>
            </td>
            </tr>
